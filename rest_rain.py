...
def main():
    ...
    marker_cluster.save("html/ChainsCluster.html")
    
    #not chain
    data = pd.read_csv('data/bar.csv')
    data1 = pd.read_csv('data/bbq.csv')
    data2 = pd.read_csv('data/cafe.csv')
    data3 = pd.read_csv('data/ice.csv')
    data4 = pd.read_csv('data/fast_food.csv')
    data5 = pd.read_csv('data/restaurant.csv')
    ...
    marker_cluster.save("html/NotChainsCluster.html")
